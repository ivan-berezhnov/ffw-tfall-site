  ...
  attach: function (context, settings) {
      ...
      if($('html',context).hasClass('no-touch')){
        $('.pane-bundle-video a.shadowboxvideo').attr('rel', 'shadowbox;width=1920;height=1080;player=iframe');
      }

      // brought in from assets/js/drupal.js
      $('.field-type-text-long table',context).addClass('table table-bordered');
      $('.field-type-text-with-summary table',context).addClass('table table-bordered');
