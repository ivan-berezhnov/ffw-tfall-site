    	...
    	<div class="row-fluid">
          ...
          <div class="news__image">
            ...
            <div class="news__image-caption">
              <?php print render($content['field_image']['#items'][0]['title']); ?>
            </div>
          </div>
          <?php endif; ?>
            ...
            <?php endif; ?>
              ...
              ?>
            <a class="archive-link" href="/press/latest">
	            <div class="full-list"><?php print t('More Recent Press'); ?> <span class="orange2">>></span></div>
            </a>
  				  </div>
  				</div>
