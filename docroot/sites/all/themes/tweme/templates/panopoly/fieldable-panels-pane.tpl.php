<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  ?>
      ...
      ?>
          <a href=https://www.youtube.com/watch?v=<?php print $video_id ?>?html5=1><img src=<?php print $uri ?> /></a>
      <?php
        else:
      ?>

      <a href=https://www.youtube.com/watch?v=<?php print $video_id ?>><img src=http://img.youtube.com/vi/<?php print $video_id ?>/maxresdefault.jpg /></a>
      <?php
      endif;
      ?>
