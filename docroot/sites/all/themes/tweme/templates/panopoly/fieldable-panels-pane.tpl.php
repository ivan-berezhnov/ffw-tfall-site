...
function create_video_file_template($field_video_file, $field_video_pane_thumbnail = NULL)
{
  ...
  if ($field_video_file['0']['filemime'] == 'video/youtube') {
    if (isset($field_video_pane_thumbnail)) {
      $image_uri = 'sites/default/files/' . $field_video_pane_thumbnail['0']['filename'];
...
function create_youtube_link($video_id, $image_uri = NULL)
{
  ...
  $link = '<a class="shadowboxvideo" rel="" href=http://www.youtube.com/watch_popup?v=' . $video_id . '><img src=' . $image_link . '></a>';
  return $link;
...
function create_vimeo_link($video_id, $image_uri = NULL)
{
  ...
  $link = '<a class="shadowboxvideo" rel="" href=http://player.vimeo.com/video/' . $video_id . '><img src=' . $image_link . '></a>';
  return $link;
